# ``AppleWeatherKit/WeatherService``
...
### Obtaining daily summaries

- ``dailySummary(for:including:)``
- ``dailySummary(for:startDay:endDay:including:)``
